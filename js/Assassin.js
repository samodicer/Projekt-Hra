   ...
   moveLeft(){
    ...
    drawEnemy(){
        ...
        if(this.hitted == true){
            ...
            game.context.drawImage(game.hit_sprite_sheet.image, this.hit_animation.frame * 50, this.hit_animation.row * 50 , 50, 50, game.camera.offset[0] + this.x, game.camera.offset[1] + this.y+20, 50, 50);    
        }
    }
}